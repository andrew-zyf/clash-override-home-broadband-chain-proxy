...
2. **先覆写 DNS**——fake-ip 模式下，AI 服务 / 支撑平台 / 验证域名与社交流媒体继续走域外 DoH（Google、Cloudflare），Apple / 域内 AI 走域内 DoH（阿里、腾讯）
...
5. **统一注入链式代理规则**——严格 AI 流量直接命中当前 `chainRegion` 的家宽出口，浏览器与社交流媒体等非 AI 类别继续走现有链式代理逻辑
